...
public class TextBuddy {
	 ...
	 *
	 * @param myBuddy
	 *         is the TextBuddy that is being looped.
	 *
	 */
	...
	/*
	 * This operation takes the string command type to determine the enumerated value.
	 *
	 * @param userCommand
	 *         is the string form of the command keyword
	 *
	...
	/*
	 * This operation will rename the temporary file to replace the original file.
	 *
	 * @param stringToDelete
	 *         is the string that has been left out from the original file.
	 *
	 ...
	 *
	 * @param lines
	 *         is the array of lines obtained from the old file.
	 *
	 * @param lineToDelete
	 *         is the index of the line to be deleted from the old file.
	 *
	 */
